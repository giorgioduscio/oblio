...
export class PrivilegesService {
  ...
  privileges :Privilege[] =[
    ...
    {
      title: `Robustezza`,
      description: `Il massimo dei punti ferita del personaggio aumenta di 1 ogni volta che acquisisce un nuovo privilegio o acquisisce un livello di un privilegio che ha già`,
      cost: 1,
      maxLevel: 0,
    },
    {
